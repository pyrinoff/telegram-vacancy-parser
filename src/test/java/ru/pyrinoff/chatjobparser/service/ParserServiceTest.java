...
public final class ParserServiceTest extends AbstractSpringTest {
    ...
    public void parseSalary26() {
        ...
        parserService.parseSalary(cleanupText(text), vacancy);
        Assertions.assertEquals(5500, vacancy.getSalaryFrom());
        Assertions.assertEquals(7000, vacancy.getSalaryTo());
        Assertions.assertEquals(CurrencyEnum.USD, vacancy.getCurrency());
    }
    ...
    public void parseSalary27() {
        ...
        Assertions.assertThrows(VacancyNotCorrect.class, () -> parserService.parseSalary(cleanupText(text), vacancy));
    }
    ...
    public void parseSalary28() {
        ...
        parserService.parseSalary(cleanupText(text), vacancy);
        Assertions.assertEquals(230000, vacancy.getSalaryFrom());
        Assertions.assertEquals(230000, vacancy.getSalaryTo());
        Assertions.assertEquals(CurrencyEnum.RUB, vacancy.getCurrency());
    }
