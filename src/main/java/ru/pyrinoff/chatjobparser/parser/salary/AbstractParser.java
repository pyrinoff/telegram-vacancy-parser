...
public abstract class AbstractParser {
    ...
    protected static @Nullable CurrencyEnum getCurrencyByString(@Nullable final String currencyString) {
        ...
        if (currencyString.equals("$") || currencyString.equals("usd") || currencyString.equals("eur") || currencyString.startsWith("доллар"))
    ...
    protected @Nullable SalaryParserResult parseDefault(
        ...
        for (int i = 0; i < matches.size(); i++) {
            ...
            if (salaryParserData.getValueFrom() != null) {
                valueFromInt = IntegerUtils.parseInt(salaryParserData.getValueFrom());
                if (isK) valueFromInt *= 1000;
            }

            if (salaryParserData.getValueTo() != null) {
                valueToInt = IntegerUtils.parseInt(salaryParserData.getValueTo());
                if (isK) valueToInt *= 1000;
            }
